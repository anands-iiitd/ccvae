...
# Add arguments.
parser.add_argument('--cuda', type=bool, default=False, help="run the "
                                                             "following code "
                                                             "on a GPU")
...
parser.add_argument('--style_dim', type=int, default=16,
                    help="dimension of style latent space")
parser.add_argument('--class_dim', type=int, default=16,
                    help="dimension of class latent space")
...
parser.add_argument('--reconstruction_coef', type=float, default=2.,
                    help="coefficient for reconstruction term")
parser.add_argument('--reverse_cycle_coef', type=float, default=10.,
                    help="coefficient for reverse cycle loss term")
parser.add_argument('--kl_divergence_coef', type=float, default=3.,
                    help="coefficient for KL-Divergence loss term")
...
parser.add_argument('--encoder_save', type=str, default='encoder',
                    help="model save for encoder")
parser.add_argument('--decoder_save', type=str, default='decoder',
